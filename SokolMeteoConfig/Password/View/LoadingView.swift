...
extension BlackBoxController: CustomLoadingBlackBoxDelegate {
    func buttonClose() {
        animateOut()
    }
...
//        self.navigationController?.popToViewController(vc!, animated: true)
    ...
    func setAlert() {
        ...
        alertView.set(title: "Связь потеряна", body: "Соединение с метеостанцией \(nameDevice) прервано", buttonTitle: "Остановить")
