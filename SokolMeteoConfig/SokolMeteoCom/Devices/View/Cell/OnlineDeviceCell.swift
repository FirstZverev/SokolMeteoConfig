//
//  OnlineDeviceCell.swift
//  SOKOL
//
//  Created by Володя Зверев on 23.12.2020.
//  Copyright © 2020 zverev. All rights reserved.
//

import UIKit

class OnlineDeviceCell: UITableViewCell {
    ...
    func initialize() {
        ...
        labelValue.font = UIFont(name:"FuturaPT-Light", size: screenW / 23)
...
//            self.content!.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -5),
            ...
            self.label!.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -50),
            self.label!.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 20),
...
//            self.labelMac!.trailingAnchor.constraint(equalTo: self.nextImage!.leadingAnchor, constant: -20),
            ...
            self.labelValue!.leadingAnchor.constraint(equalTo: self.imageUI!.trailingAnchor, constant: 10),
            self.labelValue!.topAnchor.constraint(equalTo: self.label.bottomAnchor, constant: 10),
