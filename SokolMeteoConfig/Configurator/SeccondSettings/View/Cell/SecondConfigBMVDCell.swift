//
//  SecondConfigBMVDCell.swift
//  SokolMeteoConfig
//
//  Created by Володя Зверев on 19.08.2020.
//  Copyright © 2020 zverev. All rights reserved.
//

import UIKit

class SecondConfigBMVDCell: UITableViewCell {
...
//            self.content!.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -5),
            ...
            self.label!.topAnchor.constraint(equalTo: imageUI.topAnchor, constant: -5),
